...
function generar_player2(){
    ...
    function colocarlos2(dades){
        ...
        while(ample_edificis_pergorilla[colocarmono_player2] > 700){
...
function joc(){
    ...
    if(player1_attributes.turn){
        ...
        $("#boto_llensador_player2").fadeIn("fast");
        $("#boto_llensador").hide();
...
function convidat_animate_bras(){
    switch(getplayer1_posicio()){
        case 0: //alert(getplayer2_posicio());
            ...
            var allmono = Snap("#grup_total");
            //var bras = $("#bras_llensador");
            var bras_esquerra = player1snap.select('#bras_esquerra');
            bras_esquerra.animate(
                {transform: 'r75,160,160'},600,mina.bounce,function(){
                    load_banana_convidat(0,getplayer1_position_x(),getplayer1_position_y());
                    bras_esquerra.animate({transform:'t-30,-39'},600,mina.elastic);
        ...
        case 1: // alert(getplayer2_posicio());
            ...
            var allmono = Snap("#grup_total");
            //var bras = $("#bras_llensador");
            var bras_dret = player1snap.select('#bras_dret');

            //BRAS DRET ANIMACIO FINAL
            bras_dret.animate(
                {transform: 'r-75,135,135'},600,mina.bounce,function(){
                    //alert("ei");
                    load_banana_convidat(1,getplayer1_position_x(),getplayer1_position_y());
                    bras_dret.animate({transform: '0,0'},600,mina.elastic);
...
function load_banana_convidat(posiciojugador,player_x,player_y){
    //posiciojugador=0;
    //posiciojugador=0;
    if(posiciojugador===0){
        var s = Snap("#finestrajoc");
        ...
        function colplatan(data){
            ...
            //set_velocitat_i_angles();
            datosplatano.angle= angles2;
            datosplatano.gravetat = gravetat;            
            datosplatano.velocitat = velocitat2;
